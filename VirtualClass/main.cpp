...
#define VIRTUAL_CALL(class_to_call, method_to_call)                                \
class_to_call->virtual_table[#method_to_call]();
...
DECLARE_METHOD(Derived, OnlyDerived, []() { std::cout << "OnlyDerived ::OnlyDerived" << std::endl; })
